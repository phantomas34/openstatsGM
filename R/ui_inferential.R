# R/ui_inferential.R (WCAG Headings Fix)
...
inferential_tab_ui <- accordion(
  ...
  accordion_panel(
    ...
    with_info_popover(
      ui_element = h3(class = "h4", "One-Proportion Test"),
    ...
    verbatimTextOutput("prop_test_result") %>% withSpinner(),
    
    hr(),
    with_info_popover(
      ui_element = h3(class = "h4", "Two-Proportion Test"),
    ...
    verbatimTextOutput("two_prop_test_result") %>% withSpinner()
  ),
  ...
  accordion_panel(
    ...
    with_info_popover(
      ui_element = h3(class = "h4", "Chi-Squared Test / Contingency Table"),
    ...
    navset_card_tab(
      ...
      nav_panel(
        ...
        verbatimTextOutput("chi_sq_table_output") %>% withSpinner()
      ),
      nav_panel(
        "Chi-Squared Test", 
        verbatimTextOutput("chi_sq_test_output") %>% withSpinner()
      )
    )
  ),
  ...
  accordion_panel(
    ...
    with_info_popover(
      ui_element = h3(class = "h4", "Normality Check (for n < 30)"),
    ...
    plotOutput("normality_plot") %>% withSpinner(),
    verbatimTextOutput("shapiro_wilk_output") %>% withSpinner()
  ),
  ...
  accordion_panel(
    title = "Mean Tests",
    with_info_popover(
      ui_element = h3(class = "h4", "Hypothesis Testing (t-test)"),
    ...
    verbatimTextOutput("ht_output") %>% withSpinner(),
    hr(),
    with_info_popover(
      ui_element = h3(class = "h4", "Paired t-test"),
    ...
    verbatimTextOutput("paired_ttest_result") %>% withSpinner(),
    hr(),
    with_info_popover(
      ui_element = h3(class = "h4", "ANOVA (Analysis of Variance)"),
    ...
    verbatimTextOutput("anova_output") %>% withSpinner()
  ),
  ...
  accordion_panel(
    ...
    with_info_popover(
      ui_element = h3(class = "h4", "Mann-Whitney U Test"),
    ...
    verbatimTextOutput("mw_test_output") %>% withSpinner(),
    
    hr(),
    
    with_info_popover(
      ui_element = h3(class = "h4", "Kruskal-Wallis Test"),
    ...
    verbatimTextOutput("kw_test_output") %>% withSpinner()
  )
)